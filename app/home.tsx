    ...
    return(
        <View className="flex flex-col">
            <View className="h-[50vh] bg-black flex justify-center items-center">
                ...
                <Text className="text-white font-medium text-[20px] font-poppins pt-2">Dr. Ravi</Text>
                ...
                {data.map((item) => (
                    <View className="">
                        <TouchableOpacity
                            ...
                            onPress={() => navigation.navigate('patient', {id : item.unique_id})} // Navigate to the "patient" screen
                        >
                            ...
                            <SeverityCircle value={item.last_severity_score ? item.last_severity_score : 0} />
                            </View>
                        </TouchableOpacity>
                    </View>
                ))}
